...
#ifndef PROTOBUF_base_2flabel_2eproto__INCLUDED
#define PROTOBUF_base_2flabel_2eproto__INCLUDED
...
class Label : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:firmament.Label) */ {
 public:
  Label();
  virtual ~Label();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_base_2flabel_2eproto_impl();
  friend void  protobuf_AddDesc_base_2flabel_2eproto_impl();
  friend void protobuf_AssignDesc_base_2flabel_2eproto();
  friend void protobuf_ShutdownFile_base_2flabel_2eproto();
...
#endif  // PROTOBUF_base_2flabel_2eproto__INCLUDED
